# Min-norm element in convex hull of gradient vectors (NumPy version).
# From: Multi-Task Learning as Multi-Objective Optimization
#       Ozan Sener, Vladlen Koltun, NeurIPS 2018
#       https://github.com/intel-isl/MultiObjectiveOptimization
# Used by synthetic domain (autograd/numpy-based methods).
...
class MinNormSolver:
    ...
    def find_min_norm_element(vecs):
        ...
        vecs: list of numpy arrays (each shape (n_params,))
